...
def _get_profil_snapshot() -> dict:
    ...
    with get_session() as session:
        ...
        if p is None or p.gamification is None:
            return {
        ...
        return {
            "xp": g.xp or 0,
            "niveau": g.niveau or 1,
            "streak": g.streak_jours or 0,
            "streak_record": g.streak_record or 0,
            "nb_quiz": g.nb_quiz_total or 0,
            "nb_maitrise": g.nb_chapitres_maitrise or 0,
        }
